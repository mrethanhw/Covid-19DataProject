...
for n in names:
    ...
    for o in calc.getArray(dfny.loc[n]['details.Outdoor and recreation.names']):
        if o == o:
            o = o.lower()
            if 'dock' in o or 'pier' in o or 'outdoor' in o or 'camp' in o or 'tennis' in o or 'playground' in o or 'pool' in o or 'beach' in o or 'park' in o or 'golf' in o or 'court' in o or 'trail' in o or 'marina' in o or 'fishing' in o or 'campground' in o or 'zoo' in o:
