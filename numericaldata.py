...
for file in os.scandir(directory):
    if "states_daily_2pm" in file.path:
        daily_csv = pd.read_excel(file.path, usecols=['date', 'state', 'hospitalizedCurrently', 'positiveIncrease', 'deathIncrease','totalTestResultsIncrease'],index_col = "state")
